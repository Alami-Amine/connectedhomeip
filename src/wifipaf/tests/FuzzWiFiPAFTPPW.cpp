...
/**
 *    @file
 *      Seeded FuzzTest harness for WiFiPAFTP — the PAF transport-level
 *      analogue of FuzzBtpEnginePW. Mirrors the existing libFuzzer
 *      FuzzWiFiPAFTP but seeds the mutator with real PAFTP fragment
 *      shapes so it starts past the header-validation gate.
 */
