...
{
    return {
        SpanToString(sTestCert_Root01_DER),
        SpanToString(sTestCert_Root02_DER),
        SpanToString(sTestCert_Root03_DER),
        SpanToString(sTestCert_ICA01_DER),
        SpanToString(sTestCert_ICA02_DER),
        SpanToString(sTestCert_ICA01_1_DER),
        SpanToString(sTestCert_FWSign01_DER),
        SpanToString(sTestCert_Node01_01_DER),
        SpanToString(sTestCert_Node01_02_DER),
    };
}
...
{
    return {
        SpanToString(sTestCert_Root01_PublicKey),
        SpanToString(sTestCert_Root02_PublicKey),
        SpanToString(sTestCert_Root03_PublicKey),
        SpanToString(sTestCert_ICA01_PublicKey),
        SpanToString(sTestCert_ICA02_PublicKey),
        SpanToString(sTestCert_Node01_01_PublicKey),
        SpanToString(sTestCert_Node01_02_PublicKey),
        SpanToString(sTestCert_FWSign01_PublicKey),
    };
}
...
{
    return {
        SpanToString(sTestCert_Root01_SubjectKeyId),
        SpanToString(sTestCert_Root01_AuthorityKeyId),
        SpanToString(sTestCert_ICA01_SubjectKeyId),
        SpanToString(sTestCert_ICA01_AuthorityKeyId),
        SpanToString(sTestCert_Node01_01_SubjectKeyId),
        SpanToString(sTestCert_Node01_01_AuthorityKeyId),
        SpanToString(sTestCert_FWSign01_SubjectKeyId),
        SpanToString(sTestCert_FWSign01_AuthorityKeyId),
    };
}
...
// adversarial inputs while still going deeper than a single Next loop.
...
FUZZ_TEST(ASN1ReaderPW, ASN1ReaderCertWalk)
    .WithDomains(Arbitrary<std::string>().WithSeeds(CertDerSeeds()).WithMaxSize(8192));
...
FUZZ_TEST(ASN1ReaderPW, ASN1ReaderKeyWalk)
    .WithDomains(Arbitrary<std::string>().WithSeeds(KeySeeds()).WithMaxSize(2048));
...
FUZZ_TEST(ASN1ReaderPW, ASN1ReaderKeyIdWalk)
    .WithDomains(Arbitrary<std::string>().WithSeeds(KeyIdSeeds()).WithMaxSize(256));
...
FUZZ_TEST(ASN1ReaderPW, ASN1ReaderIdempotency)
    .WithDomains(Arbitrary<std::string>().WithSeeds(CertDerSeeds()).WithMaxSize(8192));
...
FUZZ_TEST(ASN1ReaderPW, ASN1DumpFuzz)
    .WithDomains(Arbitrary<std::string>().WithSeeds(CertDerSeeds()).WithMaxSize(8192));
...
void ASN1WriterConstructedNesting(const std::vector<uint8_t> & blob, bool encapsulate)
{
    ...
    if (encapsulate)
    {
        if (writer.StartEncapsulatedType(kASN1TagClass_Universal, /*BitString*/ 0x03, /*bitStringEncoding=*/true) ==
            CHIP_NO_ERROR)
        {
...
FUZZ_TEST(ASN1ReaderPW, ParseObjectIDFuzz)
    .WithDomains(Arbitrary<std::vector<uint8_t>>().WithMaxSize(64));
