...
from gn_target import GnTarget
from gn_writer import GnFile
...
def _bazel_to_gn(args: argparse.Namespace) -> None:
    ...
    # connectedhomeip: resolve first, so a relative --root_dir survives the chdir.
    ...
    for repo_name in b2g.repo_names(only_generated=True):
        ...
        if not update_path.exists():
            # connectedhomeip: no pw_package tree in this workspace.
            continue
